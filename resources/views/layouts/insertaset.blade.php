...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <form action="/insertaset" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card mr-3 ml-3">
                    ...
                    <div class="container">
                        <div class="mt-2 mb-3 ml-4 mr-4">
                            ...
                            <input name="kode" type="" class="form-control" id=""
                                aria-describedby="">
                            <div id="" class="form-text"></div>
                        </div>
                        <div class="mb-3 ml-4 mr-4">
                            <label for="" class="form-label">Nama Aset</label>
                            <input name="nama_aset" type="" class="form-control" id=""
                        ...
                        <div class="mb-3 ml-4 mr-4">
                            ...
                            <input name="merk" type="" class="form-control" id=""
                                aria-describedby="">
                            <div id="" class="form-text"></div>
                        </div>
                        <div class="ml-4 mb-4">
