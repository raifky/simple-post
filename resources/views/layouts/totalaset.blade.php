        ...
        <div class="content-wrapper">
            ...
            <div class="card mr-3 ml-3">
                <div class="card-header">
                    ...
                    <div class="">
                        <a href="Tambah"><button type="button" class="btn btn-primary plus float-right">Tambahkan
                                Data</button></a>
                    </div>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Master Nama Aset</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/tampilkategori/{{ $row->id }}" type="button"
                                                            class="btn btn-warning"><i
                                                                class="bi bi-pencil-square"></i></a>
                                                        <a href="/deletekategori/{{ $row->id }}" type="button"
